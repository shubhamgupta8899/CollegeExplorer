  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 h-full">
      ...
      <div className="relative h-48 overflow-hidden">
        <img
          src={college.imageUrl || "https://via.placeholder.com/400x200?text=College+Image"}
          alt={college.name}
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
          ...
          <p className="text-sm text-white/90">{college.location || "Unknown Location"}</p>
        </div>
      </div>
